...
import EditLocationServices from "./EditLocationServicesForm";

const columns: GridColDef[] = [{ field: "name", headerName: "Servicio", flex: 1 }];

type LocationServicesGridToolbarProps = {
	id: number;
	services: any[];
	handleSearch: React.ChangeEventHandler;
};

const LocationServicesGridToolbar = ({
	id,
	services,
	handleSearch,
}: LocationServicesGridToolbarProps) => {
...
const LocationServicesTable = ({ id = 1, services = [] }) => {
	...
	return (
		<Paper>
			<DataGrid
				...
				components={{
					Toolbar: LocationServicesGridToolbar,
				}}
				componentsProps={{
